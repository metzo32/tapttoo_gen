...
export default function Career() {
  ...
  return (
    <s.PageWrapper className="career-wrapper">
      <s.Image src={careerMainImage} alt="photo" className="long-img" />
      <s.SectionFrame>
        <s.CareerDiv className="career-row">
          <s.CareerDiv className="career-column">
            <s.StyledH1 className="career-title">We are hiring</s.StyledH1>
            <s.StyledP className="career-info">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem
              cum deserunt quod modi nisi? Quidem, ducimus sunt. Iusto culpa
              natus doloremque sit nemo nesciunt necessitatibus. Saepe vero
              tempora dolorem explicabo?
            </s.StyledP>
          </s.CareerDiv>
        </s.CareerDiv>
      </s.SectionFrame>
      ...
      <s.SectionFrame className="career-img-wrapper">
        <s.CareerItem
          className="half"
          onClick={() => handleCareerDetail("/joinartist")}
        >
